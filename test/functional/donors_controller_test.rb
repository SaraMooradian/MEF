...
class DonorsControllerTest < ActionController::TestCase
  ...
  test "should create donor" do
    assert_difference('Donor.count') do
      post :create, donor: { amount: @donor.amount, familyname: @donor.familyname, status: @donor.status }
    end
  ...
  test "should update donor" do
    put :update, id: @donor, donor: { amount: @donor.amount, familyname: @donor.familyname, status: @donor.status }
    assert_redirected_to donor_path(assigns(:donor))
  end
